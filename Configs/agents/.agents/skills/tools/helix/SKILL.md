---
name: helix
description: "Use Helix (hx) modal editor — selection-first editing with tree-sitter textobjects. Use when configuring keybindings, setting up language servers, or customizing themes."
token_cost: 140
related: [vscode]
keywords: ["helix", "hx", "modal", "keybinding", "theme"]
---
