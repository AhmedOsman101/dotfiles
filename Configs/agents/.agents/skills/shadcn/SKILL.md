...
allowed-tools: Bash(pnpm dlx shadcn@latest *), Bash(bunx --bun shadcn@latest *)
---
...
> **IMPORTANT:** Run all CLI commands using the project's package runner: `pnpm dlx shadcn@latest`, or `bunx --bun shadcn@latest` — based on the project's `packageManager`. Examples below use `npx shadcn@latest` but substitute the correct runner for the project.
...
pnpm dlx shadcn@latest add owner/repo/item --dry-run

# Search registries.
pnpm dlx shadcn@latest search @shadcn -q "sidebar"
pnpm dlx shadcn@latest search @tailark -q "stats"
pnpm dlx shadcn@latest search owner/repo -q "login"
pnpm dlx shadcn@latest search                          # all configured registries
pnpm dlx shadcn@latest search @shadcn -q "menu" -t ui  # filter by item type
...
pnpm dlx shadcn@latest view owner/repo/item
```
