...
Length Constraint: Target 750–800 (±50) words for a 5-minute review at 150 WPM. Hard ceiling: 1000 (±100) words (8-minute read) only if cutting would lose testable information. Use the ~/scripts/readtime script to determine the readtime.
