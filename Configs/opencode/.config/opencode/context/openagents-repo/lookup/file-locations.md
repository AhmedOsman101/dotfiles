...
| **Context files** | `/home/othman/.config/opencode/context/` |
...
| **New context** | `/home/othman/.config/opencode/context/{category}/{name}.md` |
...
```
/home/othman/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/othman/.config/opencode/context/core/standards/code-quality.md`
- `/home/othman/.config/opencode/context/ui/web/react-patterns.md`
- `/home/othman/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/othman/.config/opencode/context/{category}/

# All context
find /home/othman/.config/opencode/context -name "*.md"
```
