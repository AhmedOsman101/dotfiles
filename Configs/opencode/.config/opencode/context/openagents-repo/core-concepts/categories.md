...
/home/othman/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/othman/.config/opencode/context/{category}
...
```bash
cat > /home/othman/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/othman/.config/opencode/context/{category}/
...
Loads: `/home/othman/.config/opencode/context/ui/web/react-patterns.md`
