...
├── .cache/
│   ├── test-coverage.md (cached from /home/othman/.config/opencode/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/home/othman/.config/opencode/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /home/othman/.config/opencode/context/
ELSE:
  READ from /home/othman/.config/opencode/context/
  CACHE the file
```
