...
- Answer is in `/home/othman/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/home/othman/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/home/othman/.config/opencode/context/core/workflows/task-delegation-basics.md`
