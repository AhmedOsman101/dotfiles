...
```bash
npx ts-node /home/othman/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/othman/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
